<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="ProductType.aspx.cs" Inherits="PROGTestWebsite.ProductType" %>
        ...
        <table class="w-100">
            <tr>
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="PRODUCT_ID" DataSourceID="PRODUCTTYPEDataSource" GridLines="None" Height="542px" Width="1228px" AllowSorting="True">
                        <Columns>
                        ...
                        <asp:SqlDataSource ID="PRODUCTTYPEDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [PRODUCT_ID], [PRODUCT_TYPE], [AMOUNT], [DATE_DELIVERED] FROM [PRODUCT] WHERE (([PRODUCT_TYPE] = @PRODUCT_TYPE) AND ([FARMER_ID] = @FARMER_ID) AND ([FARMER_FULLNAME] = @FARMER_FULLNAME))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="lblProductType" Name="PRODUCT_TYPE" PropertyName="Text" Type="String" />
